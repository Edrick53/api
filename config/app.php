    ...
    'tasks' => [
        1 => [
            [
                ...
                'coords' => [
                    'latitude'  => [58.522849, 10],
                    'longitude' => [31.271194, 10],
                ],
            ],
            [
                'kvest'       => 1,
                'point'       => 1,
                'title' => 'Задание 1',
                'description' => 'С этой башни кремля открывается лучший вид на троицу.',
                'coords' => [
                    'latitude'  => [58.516234, 42],
                    'longitude' => [31.272726, 42],
                ],
            ],
            [
                'kvest'       => 1,
